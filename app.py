...
Если недостаточно информации из файла, используй свой опыт и знания, чтобы раскрыть этот раздел. """
        ...
        question21 = """Представь, ты маркетолог новой (СМО) компании, которая собирается открыться. Информация о продукте и компании содержится в файле. Твоя задача провести анализ и сделать стратегию на основе примерных данных из файла. Изучить информацию о компании (валовой продукция, остатки на начало года и конец) и подсчитать объём реализации по формуле. Сформировать финансовый результат деятельности предприятия и анализируя данные из интернета об востребованности продукта посчитать спрос на продукцию компании и эффективность её производства. Также важно учесть бюджет компании, привести примерные значения для будущего развития, и количество сотрудников, которые занимаются поставкой, разработкой новых видов и улучшений продукции и так далее. """

        question22 = """Представь, ты финансовый директор. Информацию о продукте в файле, который я тебе прислал. Твоя задача составить суммы доходов в месяц исходя из источников доходов компании, а также анализ движения наличности. Главный источник доходов – продажа продукта. Также ты должен провести оценку. Вторая задача отразить как изменится примерная прибыль за год."""
